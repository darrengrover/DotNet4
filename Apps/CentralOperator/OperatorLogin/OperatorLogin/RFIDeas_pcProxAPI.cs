...
namespace RFIDeas_pcProxAPI
{
    ...
    static class pcProxDLLAPI
    {
        ...
        [DllImport("pcProxAPI.dll")] public static extern    uint GetFirmwareVersion(short hardware, short module);
        ...
        [DllImport("pcProxAPI.dll")] public static extern  ushort SetAZERTYShiftLock(short on);
        ...
        [DllImport("pcProxAPI.dll")] public static extern  ushort SetExtendedPrecisionMath(short on);
        ...
        [DllImport("pcProxAPI.dll")] public static extern  ushort UseAsciiCommandProtocol(short useACP);
